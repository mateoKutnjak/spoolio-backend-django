...
class PrintingJob(libs_models.BaseTimestampModel):
    ...
    print_order_unit = models.ForeignKey(print_order_models.OrderUnit, on_delete=models.CASCADE)
    ...
    status = models.CharField(max_length=16, choices=PRINT_JOB_STATUS_CHOICES, default=STATUS_IN_QUEUE)
