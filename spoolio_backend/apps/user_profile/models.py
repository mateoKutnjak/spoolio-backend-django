...
class UserProfile(models.Model):
    ...
    shipping_address = models.ForeignKey(common_models.ShippingAddress, null=True, blank=True, on_delete=models.SET_NULL)
    billing_address = models.ForeignKey(common_models.BillingAddress, null=True, blank=True, on_delete=models.SET_NULL)
